...
const dataList = [
    ...
    },
    {
        "info": {
            ...
            "availability": {
                "nextCloseTime": "2023-09-12 00:59:00",
                "opened": true
            },
            "badges": {
    ...
    },
    {
        "info": {
            ...
            "availability": {
                "nextCloseTime": "2023-09-12 04:30:00",
                "opened": true
            },
            "badges": {
...
const RestaurantCard = (props) => {
    ...
    return (
        <div className="res-card" style={{ backgroundColor: "#f0f0f0" }}>
            <img className="res-img" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_264,h_288,c_fill/" + cloudinaryImageId} alt="res-img" />
            <h3>{name}</h3>
            <h5>{cuisines.join(',')}</h5>
